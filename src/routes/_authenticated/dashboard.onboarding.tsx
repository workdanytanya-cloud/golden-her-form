...
function OnboardingPage() {
  ...
  const save = async (asCompleted: boolean) => {
    ...
    if (asCompleted) {
      ...
      if (gen.errors.length > 0) {
        toast.warning("Анкета отправлена, но черновики не собраны полностью", {
          description: gen.errors.join("; "),
        });
      } else {
        toast.success("Анкета отправлена тренеру. Доступ к курсу откроется после проверки.");
      }
  ...
  const selectedDietTable = getMedicalDietTable(form.medical_diet_table);
