  ...
  return (
    <div className="space-y-8">
      <PanelHeader
        ...
        title="Промокоды"
        description="Одноразовые коды после оплаты наличными. Код открывает регистрацию и анкету; полный доступ к курсу тренер выдаёт после проверки анкеты — как обычно."
        action={
          <Link
            to="/admin"
