...
export const ONE_MAIN_UNACHIEVABLE_MESSAGE =
  'Не удалось собрать рацион в формате «На бегу» (1 основной приём + 3 перекуса без готовки) с заданными KBJU. Измените целевые показатели, доступные продукты или выберите классический формат «2 основных + 2 перекуса».';
