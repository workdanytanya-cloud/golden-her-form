        ...
        <Reveal>
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
            <a
              ...
              className="inline-flex items-center gap-3 rounded-2xl bg-gold px-8 py-4 text-sm font-medium tracking-wide text-foreground transition-transform hover:scale-[1.03]"
            >
            ...
            <a
              href="#programs"
              className="inline-flex items-center gap-3 rounded-2xl border border-ivory/30 px-8 py-4 text-sm font-medium text-ivory transition-colors hover:border-gold hover:text-gold"
            >
