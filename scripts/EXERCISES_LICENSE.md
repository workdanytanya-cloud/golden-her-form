...
Видео с YouTube зеркалируются в Supabase Storage как mp4 (`npm run exercises:mirror-yt`), чтобы клиенты смотрели без VPN.
Rutube-ссылки остаются как есть. Дополнительно можно загрузить файл вручную в админке.
