...
const sql = fs.readFileSync(
  path.join(__dirname, "../supabase/migrations/20260815210000_fix_checkins_has_role.sql"),
  "utf8",
);
...
console.error("Could not apply SQL via HTTP endpoints — run migration in Supabase SQL editor.");
process.exit(2);
